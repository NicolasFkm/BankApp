...
export class Routes {
  ...
  public routes(app: Application): void {
    ...
    app.route("/account/:id/payment").get(this.accountController.getById);
    app.route("/account/:id/withdraw").get(this.accountController.getById);
    app.route("/account/:id/deposit").get(this.accountController.getById);
